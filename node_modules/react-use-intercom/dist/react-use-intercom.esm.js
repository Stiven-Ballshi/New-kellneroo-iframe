...
var _excluded = ["appId", "autoBoot", "autoBootProps", "children", "onHide", "onShow", "onUnreadCountChange", "shouldInitialize", "apiBase", "initializeDelay"];
var IntercomProvider = function IntercomProvider(_ref) {
  ...
  var refresh = useCallback(function () {
    ensureIntercom('update', function () {
      var last_request_at = Math.floor(new Date().getTime() / 1000);
      IntercomAPI('update', {
  ...
  var showNewMessage = useCallback(function (message) {
  ...
  }, [boot, shutdown, hardShutdown, update, hide, show, isOpen, showMessages, showNewMessage, getVisitorId, startTour, trackEvent, showArticle]);
